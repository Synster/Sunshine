...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord(null,locationCursor,northPole);
    ...
    private long insertlocation(SQLiteDatabase db,ContentValues locationValue) {


        // Insert ContentValues into database and get a row ID back
        return db.insert(WeatherContract.LocationEntry.TABLE_NAME,null,locationValue);
    }
    ...
    public void testWeatherTable() {
        ...
        ContentValues weatherValue=TestUtilities.createWeatherValues(rowId);
        ...
        // query if you like)
        String error=null;
        TestUtilities.validateCurrentRecord(error,weatherCursor,weatherValue);
        assertNull(error);
        // Finally, close the cursor and database
        weatherCursor.close();
        db.close();
